    ...
    try {
      const payload = {
        ...
        seasonalPrices: seasonalPrices.map(p => ({
          ...
          pricePerKg: priceType !== 'Different Price' ? Number(p.pricePerKg) : undefined,
          priceLarge: priceType === 'Different Price' ? Number(p.priceLarge) : undefined,
          priceSmall: priceType === 'Different Price' ? Number(p.priceSmall) : undefined,
          priceMixed: priceType === 'Different Price' ? Number(p.priceMixed) : undefined,
        }))
      };
