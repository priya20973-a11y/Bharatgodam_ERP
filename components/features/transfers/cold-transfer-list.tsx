      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50">
            ...
            <TableHead className="text-right font-semibold">{t('inward.quantityHeader') || 'Net Weight'}</TableHead>
              ...
              return (
                <TableRow key={transfer._id || i} className="hover:bg-slate-50/50">
                  ...
                  <TableCell className="text-right font-medium">
                    {formatNumber(transfer.quantityKg)} {transfer.unit || transfer.commodityId?.unit || 'KG'}
                  </TableCell>
