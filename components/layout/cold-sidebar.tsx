...
const coldNavItems = [
  { name: 'Dashboard', translationKey: 'sidebar.dashboard', href: '/cold/dashboard', icon: LayoutDashboard },
  { name: 'Profile', translationKey: 'sidebar.profile', href: '/cold/profile', icon: Settings },
  { name: 'Warehouse Master', translationKey: 'sidebar.warehouse', href: '/cold/warehouses', icon: Box },
  { name: 'Floor Mapping', translationKey: 'floorMapping.title', href: '/cold/floor-mapping', icon: Grid },
  { name: 'Commodity Master', translationKey: 'sidebar.commodities', href: '/cold/commodities', icon: Package },
  { name: 'Client Master', translationKey: 'sidebar.clientMaster', href: '/cold/clients', icon: Users },
  { name: 'Inward Transaction', translationKey: 'sidebar.inward', href: '/cold/inward', icon: ArrowDownToLine },
  { name: 'Outward Transaction', translationKey: 'sidebar.outward', href: '/cold/outward', icon: ArrowUpFromLine },
  { name: 'Transaction Report', translationKey: 'sidebar.reports', href: '/cold/transactions-report', icon: ClipboardList },
  { name: 'Client Ledger', translationKey: 'sidebar.clientLedger', href: '/cold/ledger', icon: FileText },
