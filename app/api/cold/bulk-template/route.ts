...
export async function GET(request: NextRequest) {
  try {
    const csvContent = `\uFEFFType,ClientName,CommodityName,Variety,WarehouseName,Date,TruckNo,WeighbridgeSlipNo,Seed,TableLabel,CIPC,Marko,LotNo,FarmerName,VillageName,ReferencePersonName,GrossWeight,EmptyWeight,SelfPurchase,LargeBag,SmallBag,TotalBags,NetWeight,ChamberNo,FloorNo,StackNo,AllocatedWeight,AllocatedBagsCount,Grading,Remarks\nINWARD,Sample Client,Sample Commodity,Sample Variety,Sample Cold Warehouse,2026-03-02,GH-12,WB-101,Sample Seed,Table-01,,MR-88,LN-001,Farmer Name,Sample Village,Reference Person,1300,100,Self,8,4,12,1200,1,1,1,1200,10,Y,Sample inward entry`;
